...
import { useJobsStore, FETCH_JOBS, FILTER_JOBS_BY_ORGANIZATION } from '@/stores/jobs'
  ...
  computed: {
    ...
    ...mapState(useJobsStore, {
      ...
      displayJobs() {
        ...
        return this.FILTER_JOBS_BY_ORGANIZATION.slice(firstJobIndex, lastJobIndex)
      }
    })
  },
  async mounted() {
